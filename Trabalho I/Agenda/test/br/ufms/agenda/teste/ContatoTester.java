...
public class ContatoTester extends DAOTester<Contato, Integer> {
    ...
    protected void printBean(Contato bean) {
        ...
        output.append("Criação: ").append(bean.getData_criacao()).append("\n");
        output.append("Telefone: ").append(bean.getListaTelefones()).append("\n");
        System.out.println(output);
        System.out.print("Lista de Telefones:\n");
        bean.getListaTelefones().stream().forEach((t) -> {
