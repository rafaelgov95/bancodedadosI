...
import br.ufms.agenda.model.dao.TelefoneDAO;
...
public class ControllerDaos {
    ...
    public void SaveTelefone(Telefone t, Contato c) throws SQLException{
       TelefoneDAO tDao = DAOFactory.getInstance().getTelefoneDAO();
       tDao.save(t, c.getCodigo());
    }
